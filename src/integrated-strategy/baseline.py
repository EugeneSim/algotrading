...
# load price data (symbol 0001 for this script)
symbol = safe_symbol("0001")
...
plt.close() # hide figure
print("Final total value: {value:.4f} ".format(value=portfolio["total"].iloc[-1]))
print("Total return: {value:.4f}%".format(value=((portfolio["total"].iloc[-1] - portfolio["total"].iloc[0]) / portfolio["total"].iloc[0]) * 100))
